            ...
            try {
                const hemofilia = yield database_1.default.query("select * from bd_estructura_archivo_campo", function (err, result, fields) {
                    ...
                    for (const key in req.body) {
                        ...
                        if (nombrecampo == "CAMPO_19" || nombrecampo == "CAMPO_29" || nombrecampo == "CAMPO_22" || nombrecampo == "CAMPO_25" || nombrecampo == "CAMPO_29") {
                            if (validacion.isObligatorio(validacioncampo.VIGENTE)) {
                                if (validacion.isMaxMin(valorcampo, validacioncampo.LONGITUD_MINIMA, validacioncampo.LONGITUD_MAXIMA)) {
                                    console.log('Longitud no corresponde campo');
                                }
                        ...
                        //////////////////validacion campo 24 no cumple con las condiciones mejorar ///////////////////////////
                        ...
                        if (nombrecampo == "CAMPO_48" || nombrecampo == "CAMPO_48_2" || nombrecampo == "CAMPO_48_3" || nombrecampo == "CAMPO_49" || nombrecampo == "CAMPO_50" || nombrecampo == "CAMPO_51" || nombrecampo == "CAMPO_52" || nombrecampo == "CAMPO_53" || nombrecampo == "CAMPO_54" || nombrecampo == "CAMPO_55" || nombrecampo == "CAMPO_57" || nombrecampo == "CAMPO_57_1") {
                            if (validacion.isObligatorio(validacioncampo.VIGENTE)) {
                                if (validacion.isMaxMin(valorcampo, validacioncampo.LONGITUD_MINIMA, validacioncampo.LONGITUD_MAXIMA)) {
                                    console.log('Longitud no corresponde campo');
                                }
                        ...
                        /////////////////////////////VALIDACION CAMPO  60,61,62,63,64,64_2,65,66///////////////////////////
                        if (nombrecampo == "CAMPO_60" || nombrecampo == "CAMPO_61" || nombrecampo == "CAMPO_62" || nombrecampo == "CAMPO_63" || nombrecampo == "CAMPO_64_2" || nombrecampo == "CAMPO_65" || nombrecampo == "CAMPO_66") {
                            if (validacion.isObligatorio(validacioncampo.VIGENTE)) {
                                if (validacion.isMaxMin(valorcampo, validacioncampo.LONGITUD_MINIMA, validacioncampo.LONGITUD_MAXIMA)) {
                                    console.log('Longitud no corresponde campo');
                                }
