...
@Component({
  selector: 'app-cuenta-cancer-edit',
  templateUrl: './cuenta-cancer-edit.component.html',
  styleUrls: ['./cuenta-cancer-edit.component.css']
})
export class CuentaCancerEditComponent implements OnInit {
  ...
  constructor(private hemofiliaservice: HemofiliaService,private opcionesListasCancerService: OpcionesListasCancerService, activateRoute: ActivatedRoute,
