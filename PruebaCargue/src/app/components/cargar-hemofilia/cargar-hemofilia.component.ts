...
export class CargarHemofiliaComponent implements OnInit {
  ...
  cargarhemofilia() {
    ...
    //   //Add obj Hemofilia en el array
    //   arrayCH.push(this.hemofilia);
    // }

    this.hemofiliaservice.cargamasivahemofilia([],this.file,this.nombrearchivo,this.pesoarchivo).subscribe(res => {
      console.log(res)
    })

    // for (let index = 0; index < arrayCH.length; index++) {
    //   const oHemofilia = arrayCH[index];
    //   this.hemofiliaservice.cargamasivahemofilia(oHemofilia,this.file,this.nombrearchivo,this.pesoarchivo).subscribe(res => {
    //     console.log(res)
    //   })
    // }
